...
```
NOTE: We find that 100 iterations are good enough for inverting an image, which takes about 8s (on P40). But clients can always use more iterations (much slower) for a more precise reconstruction. 
